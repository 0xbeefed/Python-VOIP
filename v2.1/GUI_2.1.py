...
def loadDir():
    ...
    if DIRECTORY != '': # If user cancel, DIRECTORY == ''
        ...
        if MUSICS != []:
            ...
            checkTrack() # Start music tracker
...
def checkTrack():
    ...
    """
    global DIRECTORY, MUSICS, INDEXPLAYLIST, CHECK_ID
    ...
    CHECK_ID = gui['window'].after(500, checkTrack) # Repeat this function every 500ms
...
gui['widget']['ipEntry'].insert(END, '192.168.1.29')
